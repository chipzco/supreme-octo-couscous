...
import { VideoStudyListComponent } from './video-study/video-study-list.component';
@NgModule({
  imports: [
      CommonModule, ReportRoutingModule, FormsModule
  ],
  declarations: [ReportsComponent, VideosComponent, VideoFormComponent, RepeaterDirective, ModalComponent, ModalTriggerComponent, FakeloaderComponent, StudiesComponent, StudyFormComponent, VideoStudyComponent, VideoStudyListComponent, AdminLinksComponent,AuthComponent],
